...
> [!TIP]
> 针对听力常规会话场景及“看图答题”（Look at the graphic）的图文联动的详细精讲与配图剖析，请直接参阅：[04_听力会话场景与图表专题总结.md](file:///Users/yang/Gitlab/TOEIC/TOEIC_精读解析包/04_听力会话场景与图表专题总结.md)。该文件整理了 6 大核心场景和 10 道图表真题的双语对照录音原文与分析。
...
> [!TIP]
> 针对阅读词形词性变化、段落逻辑衔接、句子插入、多人聊天与多文档交叉推理的详细精讲与配图剖析，请直接参阅：[05_阅读真题场景与核心题型专题总结.md](file:///Users/yang/Gitlab/TOEIC/TOEIC_精读解析包/05_阅读真题场景与核心题型专题总结.md)。该文件包含各题型黄金动作拆解及多文档联动的跨篇章交叉推理。
